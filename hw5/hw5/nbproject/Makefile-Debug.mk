...
${OBJECTDIR}/PrecondViolatedExcep.o: PrecondViolatedExcep.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrecondViolatedExcep.o PrecondViolatedExcep.cpp

${OBJECTDIR}/SortedListHasA.o: SortedListHasA.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SortedListHasA.o SortedListHasA.cpp
